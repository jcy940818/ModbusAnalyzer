...
public class CustomModbusControlXmlGeneratorFrame extends JFrame {
...
//			public void run() {
//				try {
//					CustomModbusControlXmlGeneratorFrame frame = new CustomModbusControlXmlGeneratorFrame();
...
//	}
	 ...
	 * Create the frame.
	 */
	public CustomModbusControlXmlGeneratorFrame() {
		CustomModbusControlXmlGeneratorFrame.isExist = true;
		modbusPerfList = new ArrayList();		
		
		setBackground(Color.WHITE);
		setResizable(false);
		setTitle("ModbusAnalyzer : Custom Modbus Control XML Generator");
		...
		JLabel modbusXmlGenerator = new JLabel("Custom Modbus Control XML Generator");
		...
		modbusXmlGenerator.setBounds(0, 0, 582, 55);
...
//		formPanel.add(useAutoMeasure);
		...
		resetButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				resetTable(table);				
				CustomModbusControlXmlGeneratorFrame.modbusPerfList.clear();
			}
		});
	...
	@Override
	public void dispose() {
		CustomModbusControlXmlGeneratorFrame.isExist = false;
		super.dispose();
	}	
			...
			Thread thread = new Thread(new Runnable() {
				...
				public void run() {
					...
					if(userOption != JOptionPane.YES_OPTION) {															
						...
						Util.showMessage(sb.toString(), JOptionPane.ERROR_MESSAGE);
						CustomModbusControlXmlGeneratorFrame.isConverting = false;
						return;
					}else {
