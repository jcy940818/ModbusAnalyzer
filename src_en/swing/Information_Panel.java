...
public class Information_Panel extends JPanel {
	...
	public Information_Panel() {
		...
		JLabel programInfo = new JLabel("Program Information (en)");
		...
		LanguageLabel.setFont(new Font("맑은 고딕", Font.BOLD, 22));
	...
	public void showLoginForm(boolean isMoon) {
		if(ONION_Info.onionLogin) {
			if(ONION_Info.userFullName != null) {	
				...
				Util.showMessage(String.format("<font color='blue'>User authentication completed%s</font>\nUser Name : ONION%s\n", Util.separator, Util.separator), JOptionPane.INFORMATION_MESSAGE);
			}
		 }else {
	...
	public static void setVersion(String version) {
		Information_Panel.versionLabel.setText(String.format("<html><font color='black'>Version</font> <font color='red'>%s</font></html>", version));
	}
	...
	public static void loginOnionMemeber(String member) {
		if(member.equalsIgnoreCase("Moon")) {
			...
			src_ko.swing.Information_Panel.user.setText("<html><font color='blue'>Developer</font> : </html>");
			src_ko.swing.Information_Panel.userName.setIcon(new Util().getMoonResource());
			src_ko.swing.Information_Panel.userName.setText(ONION_Info.userFullName);
		}else {
			user.setText(String.format("<html><font color='orange'>ONION Member</font> : %s</html>", ONION_Info.userFullName));
			userName.setIcon(null);
			userName.setText(null);
			
			src_ko.swing.Information_Panel.user.setText(String.format("<html><font color='orange'>ONION Member</font> : %s</html>", ONION_Info.userFullName));
			src_ko.swing.Information_Panel.userName.setIcon(null);
			src_ko.swing.Information_Panel.userName.setText(null);
		}
	}
}
