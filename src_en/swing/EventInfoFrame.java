...
public class EventInfoFrame extends JFrame {
	...
	public EventInfoFrame() {
		...
		autoEvent.setFont(new Font("맑은 고딕", Font.BOLD, 22));
		...
		eventType.setFont(new Font("맑은 고딕", Font.BOLD, 17));
		...
		eventType_value.setFont(new Font("맑은 고딕", Font.BOLD, 17));
		...
		eventName.setFont(new Font("맑은 고딕", Font.BOLD, 17));
		...
		eventName_value.setFont(new Font("맑은 고딕", Font.BOLD, 17));
		...
		eventName_TextField.setFont(new Font("맑은 고딕", Font.BOLD, 17));
		...
		severity.setFont(new Font("맑은 고딕", Font.BOLD, 17));
		...
		eventSeverity_ComboBox.setFont(new Font("맑은 고딕", Font.BOLD, 17));
		...
		eventCondition.setFont(new Font("맑은 고딕", Font.BOLD, 17));
		...
		eventThreshold_TextField.setFont(new Font("맑은 고딕", Font.BOLD, 17));
...
//				}
		...
		eventOperation_ComboBox.setFont(new Font("맑은 고딕", Font.BOLD, 17));
		...
		eventMode.setFont(new Font("맑은 고딕", Font.BOLD, 17));
...
//				}				
		...
		eventMode_ComboBox.setFont(new Font("맑은 고딕", Font.BOLD, 13));
		...
		eventDuration.setFont(new Font("맑은 고딕", Font.BOLD, 17));
		...
		eventDuration_TextField.setFont(new Font("맑은 고딕", Font.BOLD, 17));
		...
		eventDuration_value2.setFont(new Font("맑은 고딕", Font.BOLD, 17));
		...
		eventCount.setFont(new Font("맑은 고딕", Font.BOLD, 17));
		...
		eventCount_TextField.setFont(new Font("맑은 고딕", Font.BOLD, 17));
		...
		eventCount_value2.setFont(new Font("맑은 고딕", Font.BOLD, 17));
		...
		maxCount.setFont(new Font("맑은 고딕", Font.BOLD, 14));
		...
		eventMessage.setFont(new Font("맑은 고딕", Font.BOLD, 17));
		...
		eventMessage_TextArea.setFont(new Font("맑은 고딕", Font.BOLD, 16));				
		...
		eventAutoClose.setFont(new Font("맑은 고딕", Font.BOLD, 17));
		...
		eventAutoClose_CheckBox.setFont(new Font("맑은 고딕", Font.BOLD, 17));
