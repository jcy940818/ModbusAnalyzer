...
public class ProcedureGeneratorFrame extends JFrame {
	...
	public ProcedureGeneratorFrame() {
		...
		lblContentsOfThe.setFont(new Font("맑은 고딕", Font.BOLD, 17));
		...
		lblContentsOfThe_1.setFont(new Font("맑은 고딕", Font.BOLD, 17));
		...
		lblParametersOfThe.setFont(new Font("맑은 고딕", Font.BOLD, 17));
