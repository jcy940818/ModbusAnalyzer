...
//				if(!ModbusCollectionFrame.isExist) modbusCollection = new ModbusCollectionFrame();
		...
		user_resetButton.setFont(new Font("맑은 고딕", Font.BOLD, 14));
		...
		user_sendPacketButton.setFont(new Font("맑은 고딕", Font.BOLD, 14));
		...
		startAddress_label.setFont(new Font("맑은 고딕", Font.BOLD, 15));
		...
		sendType.setFont(new Font("맑은 고딕", Font.BOLD, 15));
