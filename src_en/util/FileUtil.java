...
public class FileUtil {
	...
	public static boolean init(boolean isProject) {		
		...
		try {			
			...
			sb.append(String.format("%sThe file required to perform the function failed to load from the directory path you entered%s\n\n", Util.colorRed("Failed to execute\n"), Util.separator + Util.separator));
	...
	public static boolean initDecompiler() {
		...
		if(decompiler != null) {
			...
			StringBuilder sb = new StringBuilder();
			sb.append(String.format("%sLoading of files required to perform the function from the directory path below failed%s\n\n", Util.colorRed("Failed to execute\n"), Util.separator + Util.separator));
	...
	public static boolean initClassFile(boolean isProject) {
		try {
			...
			if(!isProject && !isOnionDir(ONION_PATH)) {
				...
				StringBuilder sb = new StringBuilder();
				sb.append(String.format("%sLoading of files required to perform the function from the directory path below failed%s\n\n", 
						Util.colorRed("Invalid OnionSoftware directory path\n"), Util.separator + Util.separator));
	...
	// 클래스 파일 디컴파일
	public static void decompileClass(File decompiler,File classFile) throws IOException{
