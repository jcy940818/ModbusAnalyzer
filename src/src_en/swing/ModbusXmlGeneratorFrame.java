...
//	}
	...
	public ModbusXmlGeneratorFrame() {
		...
		convertModbusXML_Button.setText(" XML Generate");
		...
		convertModbusXML_Button.setBounds(782, 11, 257, 36);
...
//			}
		...
		table.getColumnModel().getColumn(3).setPreferredWidth(150); // 레지스터 주소
		table.getColumnModel().getColumn(4).setPreferredWidth(150); // 모드버스 주소
