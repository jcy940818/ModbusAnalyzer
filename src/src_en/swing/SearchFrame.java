...
//	}
	...
	public SearchFrame(AdminConsole_Info AdminConsole, String SqlServerInfo) {
		...
		lblDeviceName.setFont(FontManager.getFont(Font.BOLD, 16));
		...
		searchButton.setFont(FontManager.getFont(Font.BOLD, 17));
		...
		result_Label.setFont(FontManager.getFont(Font.BOLD, 16));
		...
		result_value_label.setFont(FontManager.getFont(Font.BOLD, 18));
		...
		facility_label.setFont(FontManager.getFont(Font.BOLD, 16));
		...
		method_label.setFont(FontManager.getFont(Font.BOLD, 16));
		...
		message_label.setFont(FontManager.getFont(Font.BOLD, 16));
