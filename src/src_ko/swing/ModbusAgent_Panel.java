...
public class ModbusAgent_Panel extends JPanel {			
	...
	public ModbusAgent_Panel(){	
		...
		user_resetButton.setFont(FontManager.getFont(Font.BOLD, 13));
		...
		user_sendPacketButton.setFont(FontManager.getFont(Font.BOLD, 13));
		...
		sendType.setFont(FontManager.getFont(Font.BOLD, 16));
