...
public class MainFrame extends JFrame {
	...
	public MainFrame(){
		...
		modbusMonitor_V2.setFont(FontManager.getFont(Font.PLAIN, 14));
		...
		mk119Lite.setFont(FontManager.getFont(Font.BOLD, 14));
		...
		// MK119 메뉴 : XML 뷰어
		JMenuItem xmlViewer = new JMenuItem("MK119 : 프로토콜 검색     ");
		...
		xmlGeneratorMenu = new JMenuItem("MK119 : 프로토콜 XML 생성   ");
...
//		xmlGeneratorMenu.add(xmlGenerator_Control);
		...
		// Moon 메뉴 : 간편한 XML 조회
		JMenuItem moonXmlViewer = new JMenuItem("MK119 : 프로토콜 검색");
...
//		moonMenu.add(new JSeparator());
		...
		// Moon 메뉴 : 디컴파일
		JMenuItem moonDecompile = new JMenuItem("Class Decompile : 클래스 디컴파일  ");
		moonDecompile.setHorizontalAlignment(SwingConstants.LEFT);
		moonDecompile.setFont(FontManager.getFont(Font.BOLD, 14));
		moonDecompile.setForeground(Color.RED);
//		moonMenu.add(moonDecompile);
		...
		/** Class Decompile : Moon *******************************/
		DecompilePanel decompilePanel = new DecompilePanel();
		actualPanel.add(decompilePanel, "decompilePanel");
		moonDecompile.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				cardLayout.show(actualPanel, "decompilePanel");
			}
		});
