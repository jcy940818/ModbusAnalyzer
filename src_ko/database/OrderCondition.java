...
public class OrderCondition {
	...
	public static OrderCondition createOrderCondition() {
		...
		try {											 			
			JLabel title = new JLabel("<html>정렬 기준 추가&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br></html>");
			title.setFont(titlefont);
									
			// 1. 정렬 기준 컬럼 선택 문자열
			String selectColumn = "<html><br><font color='blue'>1. 정렬 기준 컬럼 선택</font></html>";																		
			...
			columnList_ComboBox.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					String[] conditions = {
							String.format("%s 컬럼 내용을 기준으로 오름차순 정렬", selectedColumn),
							String.format("%s 컬럼 내용을 기준으로 내림차순 정렬", selectedColumn)
					};
...
//					Util.showMessage(msg, JOptionPane.PLAIN_MESSAGE);											
			...
			// 2. 정렬 조건 선택 문자열
			String selectCondition = "<html><br><font color='blue'>2. 정렬 조건 선택</font></html>";
