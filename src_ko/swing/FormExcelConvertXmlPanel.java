...
public class FormExcelConvertXmlPanel extends JPanel {	
	...
	public FormExcelConvertXmlPanel() { 
		...
		dragAndDrop_TextField.setFont(new Font("맑은 고딕", Font.BOLD, 22));		
		...
		downloadFormExcel_Button.setFont(new Font("맑은 고딕", Font.BOLD, 19));		
		...
		lblXmlType.setFont(new Font("맑은 고딕", Font.BOLD, 20));
		...
		typeCommon_radioButton.setFont(new Font("맑은 고딕", Font.BOLD, 20));
		...
		typeSNMP_radioButton.setForeground(Color.LIGHT_GRAY);
		typeSNMP_radioButton.setFont(new Font("맑은 고딕", Font.BOLD, 20));
		...
		typeControl_radioButton.setForeground(Color.LIGHT_GRAY);
		typeControl_radioButton.setFont(new Font("맑은 고딕", Font.BOLD, 20));
		...
		lblXmlEncoding.setFont(new Font("맑은 고딕", Font.BOLD, 20));
		...
		eucKr_button.setFont(new Font("맑은 고딕", Font.BOLD, 20));
		...
		utf8_button.setForeground(Color.LIGHT_GRAY);
		utf8_button.setFont(new Font("맑은 고딕", Font.BOLD, 20));
