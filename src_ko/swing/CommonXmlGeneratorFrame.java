...
//	}
	...
	public CommonXmlGeneratorFrame() {
		...
		CommonXmlGenerator.setFont(new Font("맑은 고딕", Font.BOLD, 22));
		...
		JLabel addressInfo = new JLabel("\uC131\uB2A5 \uAC04\uD3B8 \uC5C5\uB85C\uB4DC");
...
//		useAutoEvent.setSelected(Event.useAutoEvent);
		...
		JButton btnNewButton = new JButton("\uC131\uB2A5 \uC815\uBCF4 \uC785\uB825");
	...
	public static void resetTable(JTable table){
		...
		table.getColumnModel().getColumn(PERF_NAME).setPreferredWidth(260); // 성능명
		table.getColumnModel().getColumn(PERF_COUNTER).setPreferredWidth(280); // 성능 카운터
