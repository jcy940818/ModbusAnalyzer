...
public class ProtocolDownloadPanel extends JPanel {	
	...
	public ProtocolDownloadPanel() {
		...
		onionDirPathLabel.setFont(new Font("맑은 고딕", Font.BOLD, 26));
		...
		onionDirPath_TextField.setFont(new Font("맑은 고딕", Font.PLAIN, 18));
		...
		msgLabel.setFont(new Font("맑은 고딕", Font.PLAIN, 13));
		...
		mk119Icon.setFont(new Font("맑은 고딕", Font.BOLD, 23));
		...
		mk119Icon2.setFont(new Font("맑은 고딕", Font.BOLD, 23));
		...
		mk119Version.setFont(new Font("맑은 고딕", Font.BOLD, 23));
		...
		goDirButton = new JButton(" 파일 다운로드 경로 열기");
		...
		isProject_checkBox.setFont(new Font("맑은 고딕", Font.BOLD, 18));
