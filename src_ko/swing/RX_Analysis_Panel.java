...
public class RX_Analysis_Panel extends JPanel {
	...
	public RX_Analysis_Panel(){
		...
		info_label0.setFont(new Font("맑은 고딕", Font.BOLD, 15));
		...
		info_value_label0.setFont(new Font("맑은 고딕", Font.BOLD, 16));
		...
		info_label1.setFont(new Font("맑은 고딕", Font.BOLD, 15));
		...
		info_value_label1.setFont(new Font("맑은 고딕", Font.BOLD, 15));
		...
		info_label2.setFont(new Font("맑은 고딕", Font.BOLD, 15));		
		...
		info_value_label2.setFont(new Font("맑은 고딕", Font.BOLD, 15));
		...
		info_label3.setFont(new Font("맑은 고딕", Font.BOLD, 15));
		...
		info_value_label3.setFont(new Font("맑은 고딕", Font.BOLD, 15));
		...
		info_label4.setFont(new Font("맑은 고딕", Font.BOLD, 15));
		...
		info_value_label4.setFont(new Font("맑은 고딕", Font.BOLD, 15));
		...
		info_label5.setFont(new Font("맑은 고딕", Font.BOLD, 15));
		...
		info_value_label5.setFont(new Font("맑은 고딕", Font.BOLD, 15));
		...
		info_label6.setFont(new Font("맑은 고딕", Font.BOLD, 15));
		...
		info_value_label6.setFont(new Font("맑은 고딕", Font.BOLD, 15));
		...
		info_label7.setFont(new Font("맑은 고딕", Font.BOLD, 15));
		...
		info_value_label7.setFont(new Font("맑은 고딕", Font.BOLD, 15));
		...
		summary_label0.setFont(new Font("맑은 고딕", Font.BOLD, 15));
		...
		summary_label1.setFont(new Font("맑은 고딕", Font.BOLD, 15));
		...
		RX.setFont(new Font("맑은 고딕", Font.BOLD, 16));
		...
		inputTextField.setFont(new Font("맑은 고딕", Font.BOLD, 15));
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(isRTU) {
					...
					if(rx.isRead()) {
						...
						info_label1.setText("Modbus Type(모드버스 타입)");
						info_value_label1.setText(isRTU?"Modbus RTU":"Modbus TCP");
						
						// 응답 내용  (코일 상태 요청, 레지스터 값 요청..)
						info_label2.setText("Response Content(응답 내용)");
						info_value_label2.setText(String.format("%s 응답", rx.getCommandType()));
						
						// 장비 번호
						info_label3.setText("Unit ID(장비번호)");
						info_value_label3.setText(String.format("%d번 장비", rx.getUnitId()));
						...
						switch(rx.getFunctionCode()) {
							case 1 : registerName="코일 상태"; break;
							default : registerName="레지스터"; break;
						}
						
						// 읽은 레지스터 개수
						if (rx.isException()) {
							// 예외 응답 처리
							info_label5.setText("Exception Code(예외 코드)");
							info_value_label5.setText(String.format("0x%02x", rx.getExceptionCode()));
							
							// 예외 응답 처리
							info_label6.setText("Exception Content(예외 내용)");
							info_value_label6.setText(rx.getExceptionContent());
						}else {
							// 읽은 레지스터 개수
							info_label5.setText(String.format("Read Register Count(읽은 %s 개수)", registerName));
							info_value_label5.setText(String.format("%d개", rx.getRequestCount()));
							
							// 읽은 레지스터 길이
							info_label6.setText(String.format("Read Register Length(읽은 %s 길이)", registerName));
						...
						info_label0.setText("Exception(예외 패킷 여부)");
						...
						info_value_label0.setFont(new Font("맑은 고딕", Font.BOLD, 15));
						info_value_label0.setHorizontalAlignment(SwingConstants.LEFT);				
						
						
						// 응답 내용  (코일 상태 요청, 레지스터 값 요청..)
						info_label1.setText("Response Content(응답 내용)");
						info_value_label1.setText(String.format("%s 성공", rx.getCommandType()));
						
						// 장비 번호
						info_label2.setText("Unit ID(장비번호)");
						info_value_label2.setText(String.format("%d번 장비", rx.getUnitId()));
						...
						info_value_label4.setText(String.format("0x%04x (레지스터 주소)", rx.getStartAddress()&0xffff ));											
						
						// 제어 요청한 모드버스 주소
						info_label5.setText("Control Modbus Address(제어 주소)");
						info_value_label5.setText(String.format("%s%04d (모드버스 주소)", rx.getModbusAddress(), rx.getStartAddress()+1));
						
						// 제어 요청한 값									
						info_label6.setText((rx.getFunctionCode()==0x05)?"Control Status(요청한 제어 상태)":"Control Value(요청한 제어 값)");
					...
					if(rx.isRead()) {
						...
						info_label3.setText("Transaction ID(트랜잭션 ID)");
						info_value_label3.setText(String.format("0x%04x", rx.getTransactionId()&0xffff));
						
						// 장비 번호
						info_label4.setText("Unit ID(장비번호)");
						info_value_label4.setText(String.format("%d번 장비", rx.getUnitId()));
						
						// 기능 코드
						info_label5.setText("Function Code(기능코드)");
						...
						if (rx.isException()) {
							// 예외 응답 처리
							info_label6.setText("Exception Code(예외 코드)");
							info_value_label6.setText(String.format("0x%02x", rx.getExceptionCode()));
							
							info_label7.setText("Exception Content(예외 내용)");
							info_value_label7.setText(rx.getExceptionContent());
						}else {
							info_label6.setText(String.format("Read Register Count(읽은 %s 개수)", registerName));
							info_value_label6.setText(String.format("%d개", rx.getRequestCount()));
							
							info_label7.setText(String.format("Read Register Length(읽은 %s 길이)", registerName));
						...
						info_value_label5.setText(String.format("0x%04x (레지스터 주소)", rx.getStartAddress()&0xffff ));											
						
						// 제어 요청한 모드버스 주소
						info_label6.setText("Control Modbus Address(제어 주소)");
						info_value_label6.setText(String.format("%s%04d (모드버스 주소)", rx.getModbusAddress(), rx.getStartAddress()+1));
						
						// 제어 요청한 값									
						info_label7.setText((rx.getFunctionCode()==0x05)?"Control Status(요청한 제어 상태)":"Control Value(요청한 제어 값)");
		...
		analysisButton.setFont(new Font("맑은 고딕", Font.BOLD, 13));
		...
		expression_textField.setFont(new Font("맑은 고딕", Font.BOLD, 16));
...
//		}					
	...
	public static void resetLabel(boolean isRTU, JLabel... label) {
		if(isRTU) {
			...
			// Exception(예외 패킷 여부)
			label[0].setText("Exception(예외 패킷 여부)");
			label[1].setText(null);
			label[1].setOpaque(false);
			
			// 모드버스 타입
			label[2].setText("Modbus Type(모드버스 타입)");
			label[3].setText(null);
			
			// 응답 내용  (코일 상태 요청, 레지스터 값 요청..)
			label[4].setText("Response Content(응답 내용)");
			...
			// 읽은 레지스터 개수
			label[10].setText("Read Register Count(읽은 레지스터 개수)");
			label[11].setText(null);			
			
			// 읽은 레지스터 길이
			label[12].setText("Read Register Length(읽은 레지스터 길이)");
			...
			// Transaction ID
			label[6].setText("Transaction ID(트랜잭션 ID)");
			label[7].setText(null);			
			
			// 장비 번호
			label[8].setText("Unit ID(장비번호)");
			label[9].setText(null);
			
			// 기능 코드
			label[10].setText("Function Code(기능코드)");
			label[11].setText(null);
			
			// 읽은 레지스터 개수
			label[12].setText("Read Register Count(읽은 레지스터 개수)");
			label[13].setText(null);			
			
			// 읽은 레지스터 길이
			label[14].setText("Read Register Length(읽은 레지스터 길이)");
			label[15].setText(null);
	...
	public String printExceptionContent(RX_Info rx) {
		...
		switch(rx.getExceptionCode()) {
			...
			case 0x04 : msg = "장비에서 요청을 처리하던 중 복구할 수 없는 오류 발생"; break;
			// Acknowledge
