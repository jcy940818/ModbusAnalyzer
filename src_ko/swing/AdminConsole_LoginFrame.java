...
public class AdminConsole_LoginFrame extends JFrame {
	...
	public AdminConsole_LoginFrame(String SqlServerInfo, String agentType) {
		...
		serverPort.setFont(new Font("맑은 고딕", Font.BOLD, 20));
		...
		MK119.setFont(new Font("맑은 고딕", Font.BOLD, 24));
...
//		JLabel MK119_Version = new JLabel("4.5");
		...
		AdminConsole.setFont(new Font("맑은 고딕", Font.BOLD, 24));
		...
		SERVER.setFont(new Font("맑은 고딕", Font.BOLD, 22));
