...
//	}
	...
	public SearchFrame(AdminConsole_Info AdminConsole, String SqlServerInfo) {
		...
		searchButton.setFont(new Font("맑은 고딕", Font.BOLD, 18));
		...
		result_Label.setFont(new Font("맑은 고딕", Font.BOLD, 18));
		...
		result_value_label.setFont(new Font("맑은 고딕", Font.BOLD, 20));
		...
		facility_label.setFont(new Font("맑은 고딕", Font.BOLD, 18));
		...
		method_label.setFont(new Font("맑은 고딕", Font.BOLD, 18));
		...
		message_label.setFont(new Font("맑은 고딕", Font.BOLD, 18));
